...
export declare const showActionInfo: (rootDir: string, logger: Logger, context: import("@actions/github/lib/context").Context) => void;
export declare const getLogger: (logger?: Logger | undefined) => Logger;
 ...
 */
export declare function main(option: MainArguments): Promise<void>;
/**
 * @param {object} option option
 * @param {Logger|undefined} option.logger logger
 * @param {string|undefined} option.message message
 */
export declare function run(option: MainArguments): void;
