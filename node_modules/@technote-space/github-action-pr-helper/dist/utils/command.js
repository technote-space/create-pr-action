...
exports.updatePr = (branchName, files, output, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (pr) {
        logger.startProcess('Creating comment to PullRequest... [%s] -> [%s]', getBranch(branchName, false), misc_1.getPrHeadRef(context));
        ...
        logger.startProcess('Creating PullRequest... [%s] -> [%s]', getBranch(branchName, false), misc_1.getPrHeadRef(context));
