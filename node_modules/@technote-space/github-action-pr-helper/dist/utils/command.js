...
exports.clone = (helper, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    logger.startProcess('Running git checkout...');
    yield helper.clone(getWorkspace(), context.actionContext);
    logger.startProcess('Cloning [%s] branch from the remote repo...', yield misc_1.getPrBranchName(helper, context));
    yield helper.fetchBranch(getWorkspace(), yield misc_1.getPrBranchName(helper, context), context.actionContext);
