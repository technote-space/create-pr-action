...
exports.getNewPatchVersion = (helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    return misc_1.getCache(misc_1.getCacheKey('new-patch-version'), () => __awaiter(void 0, void 0, void 0, function* () {
        yield helper.fetchTags(getWorkspace(), context.actionContext);
        return yield helper.getNewPatchVersion(getWorkspace());
    }), context);
});
