...
exports.updatePr = (branchName, files, output, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(core_1.getInput('API_TOKEN'));
    if (core_1.getInput('API_TOKEN')) {
        yield helper.runCommand(getWorkspace(), 'git commit --allow-empty -qm "chore: trigger workflow"');
