...
const runCreatePr = (pulls, octokit, context) => { var pulls_1, pulls_1_1; return __awaiter(void 0, void 0, void 0, function* () {
    console.log(pulls);
    var e_1, _a;
    const logger = new github_action_helper_1.Logger(misc_1.replaceDirectory, true);
    const results = [];
    try {
        for (pulls_1 = __asyncValues(pulls); pulls_1_1 = yield pulls_1.next(), !pulls_1_1.done;) {
            const pull = pulls_1_1.value;
            try {
                results.push(yield createPr(logger, octokit, getActionContext(context, pull)));
            }
            catch (error) {
        ...
        try {
            if (pulls_1_1 && !pulls_1_1.done && (_a = pulls_1.return)) yield _a.call(pulls_1);
        }
...
const runCreatePrAll = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return runCreatePr(pullsForSchedule(octokit, context), octokit, context); });
/**
 * @param {GitHub} octokit octokit
 * @param {Context} context context
 * @return {AsyncIterable} pull
...
function pullsForClosed(octokit, context) {
    console.log(`${context.actionContext.repo.owner}:${getBranch(misc_1.getPrBaseRef(context), false)}`);
    return __asyncGenerator(this, arguments, function* pullsForClosed_1() {
        ...
        yield __await(yield* __asyncDelegator(__asyncValues(yield __await(command_1.getApiHelper(logger).pullsList({
            base: `${context.actionContext.repo.owner}:${getBranch(misc_1.getPrBaseRef(context), false)}`,
        }, octokit, context.actionContext)))));
    });
}
const runCreatePrClosed = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return runCreatePr(pullsForClosed(octokit, context), octokit, context); });
exports.execute = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(misc_1.isClosePR(context));
    if (misc_1.isClosePR(context)) {
        ...
        yield outputResult(yield createPr(commonLogger, octokit, context), true);
    }
    else {
