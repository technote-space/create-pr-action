...
const createCommit = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!misc_1.isTargetBranch(branchName, context, false)) {
        return;
    }
...
exports.execute = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isPush(context.actionContext)) {
        ...
        if (misc_1.checkDefaultBranch(context)) {
            try {
                results.push(yield createPr(helper, logger, octokit, getActionContext(context, misc_1.getPullsArgsForDefaultBranch(context, yield command_1.getDefaultBranch(octokit, context)))));
            }
            catch (error) {
                results.push(getResult('failed', error.message, getActionContext(context, misc_1.getPullsArgsForDefaultBranch(context, yield command_1.getDefaultBranch(octokit, context)))));
            }
        }
        try {
