...
const runCreatePr = (isClose, getPulls, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _b = __asyncValues(getPulls(octokit, context)), _c; _c = yield _b.next(), !_c.done;) {
            ...
            const isTarget = misc_1.isActionPr(actionContext) || misc_1.isNotCreatePR(actionContext) || (yield misc_1.isTargetBranch(misc_1.getPrHeadRef(actionContext), octokit, actionContext));
            let target = '';
            if (isTarget) {
