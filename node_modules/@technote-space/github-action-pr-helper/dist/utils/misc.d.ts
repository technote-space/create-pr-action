...
export declare const isTargetBranch: (branchName: string, context: ActionContext, defaultFlag?: boolean) => boolean;
...
export declare const getPullsArgsForDefaultBranch: (context: ActionContext, defaultBranch: string) => PullsParams;
