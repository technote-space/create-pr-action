...
const getPrBranchPrefix = (context) => { var _a; return _a = context.actionDetail.prBranchPrefix, (_a !== null && _a !== void 0 ? _a : `${context.actionDetail.actionRepo}/`); };
...
exports.isTargetBranch = (branchName, context, defaultFlag = true) => {
...
exports.isTargetContext = (context) => {
    var _a;
    console.log((_a = context.actionDetail.targetEvents, (_a !== null && _a !== void 0 ? _a : constant_1.DEFAULT_TARGET_EVENTS)));
    ...
    if (isPush(context.actionContext)) {
        return exports.isTargetBranch(getBranch(context.actionContext), context, false);
    }
    console.log(exports.getActionDetail('includeLabels', context, []));
    console.log(context.actionContext);
    console.log(filter_github_action_1.isTargetLabels(exports.getActionDetail('includeLabels', context, []), [], context.actionContext));
