...
exports.useNpm = (workDir, defaultFlag = false) => !fs_1.default.existsSync(path_1.default.resolve(workDir, 'yarn.lock')) && (defaultFlag || fs_1.default.existsSync(path_1.default.resolve(workDir, 'package-lock.json')));
