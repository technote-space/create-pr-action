...
class ApiHelper {
    ...
    constructor(logger, options) {
        ...
        this.pullsCreate = (branchName, detail, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            return octokit.pulls.create(Object.assign({ owner: context.repo.owner, repo: context.repo.repo, head: `${context.repo.owner}:${this.getBranch(branchName)}`, base: (yield this.getRefForUpdate(false, octokit, context)).replace(/^heads\//, '') }, detail));
        });
        /**
         ...
         */
        this.getBranch = (branch) => branch.replace(/^(refs\/)?heads/, '');
        /**
         * @param {string} branch branch
        ...
        this.pullsCreateOrUpdate = (createBranchName, detail, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (pullRequest) {
                this.logger.startProcess('Updating PullRequest... [%s] -> [%s]', this.getBranch(createBranchName), yield this.getRefForUpdate(false, octokit, context));
                ...
                this.logger.startProcess('Creating PullRequest... [%s] -> [%s]', this.getBranch(createBranchName), yield this.getRefForUpdate(false, octokit, context));
        ...
        this.pullsCreateOrComment = (createBranchName, detail, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            const pullRequest = yield this.findPullRequest(createBranchName, octokit, context);
            if (pullRequest) {
                this.logger.startProcess('Creating comment to PullRequest... [%s] -> [%s]', this.getBranch(createBranchName), yield this.getRefForUpdate(false, octokit, context));
