...
class GitHelper {
    ...
    constructor(logger, options) {
        ...
        this.getCurrentBranchName = (workDir) => __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.runCommand(workDir, 'git branch -a | grep -E \'^\\*\' | cut -b 3-'))[0].stdout[0].trim();
        });
        /**
         * @param {string} workDir work dir
        ...
        this.createBranch = (workDir, branch) => __awaiter(this, void 0, void 0, function* () {
            yield this.runCommand(workDir, { command: `git checkout -b "${branch}"` });
        });
        /**
         * @param {string} workDir work dir
        ...
        this.runCommand = (workDir, commands) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const command of (Array.isArray(commands) ? commands : [commands])) {
                    if (typeof command === 'string') {
                        ...
                        result.push({
                            ...
                            stdout: (yield this.command.execAsync(Object.assign({ cwd: workDir }, command))).split(/\r?\n/),
                        });
                    }
                }
                return result;
                ...
                console.log();
                if( error.message ) this.logger.info(error.message);
                console.log(error);
                console.trace();
                throw error;
            }
