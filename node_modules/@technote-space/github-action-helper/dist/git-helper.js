...
class GitHelper {
    ...
    constructor(logger, options) {
        ...
        this.createBranch = (workDir, branch) => __awaiter(this, void 0, void 0, function* () {
            yield this.command.execAsync({ command: `git -C ${workDir} checkout -b "${branch}"` });
        });
        /**
         * @param {string} workDir work dir
         ...
         * @return {Promise<string[]>} diff
         */
        this.getRefDiff = (workDir, baseRef, compareRef, diffFilter) => __awaiter(this, void 0, void 0, function* () {
            const toDiffRef = (ref) => /^refs\/pull\/\d+\/(merge|head)$/.test(ref) ? ref.replace(/^refs/, '') : `origin/${ref.replace(/^(refs\/)?(heads\/|remotes\/origin\/)/, '')}`;
            return (yield this.command.execAsync({
