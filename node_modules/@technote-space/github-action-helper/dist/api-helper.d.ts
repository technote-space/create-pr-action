...
export default class ApiHelper {
     ...
     */
    findPullRequest: (branchName: string, octokit: GitHub, context: Context) => Promise<PullsListResponseItem | null>;
    /**
     ...
     * @return {Promise<PullsInfo>} info
     */
    pullsCreateOrComment: (createBranchName: string, detail: PullsCreateParams, octokit: GitHub, context: Context) => Promise<PullsInfo>;
    /**
     * @param {string} branch branch
     ...
     */
    createCommentToPr: (branch: string, body: string | undefined, octokit: GitHub, context: Context) => Promise<boolean>;
    /**
