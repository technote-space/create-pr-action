...
async function run(runOptions = {}, { cli } = {}) {
    ...
    async function runUpgrades() {
        ...
        const rootPackageFile = options.cwd ? path_1.default.join(cwd, defaultPackageFilename) : defaultPackageFilename;
        ...
        let pkgs = (!options.workspaces && !((_a = options.workspace) === null || _a === void 0 ? void 0 : _a.length)) || options.root
            ? // convert Windows path to *nix path for globby
                globby_1.default.sync(rootPackageFile.replace(/\\/g, '/'), { ignore: ['**/node_modules/**'] })
            : [];
        // workspaces
        if (options.workspaces || ((_b = options.workspace) === null || _b === void 0 ? void 0 : _b.length)) {
            ...
            const [pkgData] = await (0, findPackage_1.default)({ ...options, packageFile: rootPackageFile, loglevel: 'silent' });
            const rootPkg = typeof pkgData === 'string' ? JSON.parse(pkgData) : pkgData;
            const workspaces = Array.isArray(rootPkg.workspaces) ? rootPkg.workspaces : (_c = rootPkg.workspaces) === null || _c === void 0 ? void 0 : _c.packages;
            if (!workspaces) {
                ...
                ...(options.workspaces
                    ...
                    : // --workspace
                        workspacePackageFiles.filter(pkgFile => {
                            var _a;
                            return (_a = options.workspace) === null || _a === void 0 ? void 0 : _a.some(workspace => workspaces === null || workspaces === void 0 ? void 0 : workspaces.some(workspacePattern => pkgFile === path_1.default.join(cwd, path_1.default.dirname(workspacePattern), workspace, defaultPackageFilename)));
                        })),
            ];
        }
