 ...
 */
export declare const isGithubUrl: (declaration: string) => boolean;
/**
 * Returns the embedded tag in a Github URL.
 */
export declare const getGithubUrlTag: (declaration: string) => string | null;
/**
 ...
 */
export declare function upgradeDependencyDeclaration(declaration: string, latestVersion: string, options?: UpgradeOptions): string;
/**
