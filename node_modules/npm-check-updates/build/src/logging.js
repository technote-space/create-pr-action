...
exports.printIgnoredUpdates = exports.printUpgrades = exports.printUpgradesTable = exports.toDependencyTable = exports.printJson = exports.print = exports.getGroupHeadings = void 0;
/**
 * Loggin functions.
 */
...
const getGroupHeadings = ({ color }) => {
    const chalk = color ? new chalk_1.default.Instance({ level: 1 }) : chalk_1.default;
    return {
...
exports.getGroupHeadings = getGroupHeadings;
/**
...
async function toDependencyTable({ from: fromDeps, to: toDeps, ownersChangedDeps, format, }) {
    const table = createDependencyTable(await Promise.all(Object.keys(toDeps).map(async (dep) => {
...
async function printUpgradesTable({ current, upgraded, ownersChangedDeps, }, options) {
    ...
    if ((_a = options.format) === null || _a === void 0 ? void 0 : _a.includes('group')) {
        ...
        const headings = (0, exports.getGroupHeadings)(options);
        if (groups.patch) {
            print(options, '\n' + headings.patch);
