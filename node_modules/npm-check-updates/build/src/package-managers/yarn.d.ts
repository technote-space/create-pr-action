 ...
 */
export declare function getPathToLookForYarnrc(options: Pick<Options, 'global' | 'cwd' | 'packageFile'>, readdir?: (_path: string) => Promise<string[]>): Promise<string | undefined>;
/**
