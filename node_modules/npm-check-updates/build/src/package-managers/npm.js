 ...
 */
async function viewMany(packageName, fields, currentVersion, { registry, timeout, retry } = {}, retryed = 0) {
    ...
    try {
        ...
        if (retry && ++retryed <= retry) {
            ...
            const packument = await viewMany(packageName, fields, currentVersion, { registry, timeout, retry }, retryed);
            return packument;
        }
        throw err;
    }
