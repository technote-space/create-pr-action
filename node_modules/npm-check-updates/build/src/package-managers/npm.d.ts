 ...
 */
export declare function packageAuthorChanged(packageName: string, currentVersion: VersionSpec, upgradedVersion: VersionSpec, options?: Options): Promise<boolean>;
/**
 ...
 */
export declare function viewMany(packageName: string, fields: string[], currentVersion: Version, { registry, timeout }?: {
    registry?: string;
    timeout?: number;
}): Promise<Packument>;
 ...
 * @returns            Promised result
 */
export declare function viewOne(packageName: string, field: string, currentVersion: Version, options?: Options): Promise<string | boolean | Index<string> | {
    node: string;
} | Packument[] | undefined>;
/**
 ...
 * @returns
 */
export declare const list: (options?: Options) => Promise<any>;
/**
 * @param packageName
 * @param currentVersion
 * @param options
