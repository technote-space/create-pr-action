...
const replaceNcuCommand = (command) => constant_1.TARGET_NCU_COMMANDS.reduce((command, target) => command.replace(github_action_helper_1.Utils.getPrefixRegExp(target), 'cli.js '), command);
