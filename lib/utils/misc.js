...
const getExportPathCommand = () => () => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getRunnerArguments = () => ({
    ...
    executeCommands: [getExportPathCommand()].concat(exports.replaceNcuCommands(getArrayInput('EXECUTE_COMMANDS', false, '&&', false))),
