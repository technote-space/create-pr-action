...
const { getWorkspace, getArrayInput, getBoolValue } = github_action_helper_1.Utils;
const { escapeRegExp, replaceAll, getPrefixRegExp } = github_action_helper_1.Utils;
const { isPr } = github_action_helper_1.ContextHelper;
...
exports.isTargetBranch = (branchName) => {
    const prefix = core_1.getInput('TARGET_BRANCH_PREFIX');
    if (prefix) {
