...
const { getWorkspace, getArrayInput, getBoolValue, isPr, escapeRegExp, replaceAll } = github_action_helper_1.Utils;
 ...
 */
const replaceVariables = (string, variables, context) => variables.reduce((acc, value) => replaceAll(acc, `\${${value.key}}`, value.replace(context)), string);
/**
 * @param {string} string string
 * @param {Context} context context
 * @return {string} replaced
...
exports.getPrBranchName = (context) => exports.isActionPr(context) ? exports.getPrHeadRef(context) : exports.getPrBranchPrefix() + replaceContextVariables(core_1.getInput('PR_BRANCH_NAME', { required: true }), context);
