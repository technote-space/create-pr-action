...
const getExportPathCommand = () => `export PATH=$PATH:${constant_1.BIN_PATH}`;
...
exports.getRunnerArguments = () => ({
    ...
    executeCommands: exports.replaceNcuCommands([getExportPathCommand()].concat(getArrayInput('EXECUTE_COMMANDS', false, '&&', false))),
