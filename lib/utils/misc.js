...
// ^npm-check-updates
// ^ncu
const replaceNcuCommand = (command) => constant_1.TARGET_NCU_COMMANDS.reduce((command, target) => command.replace(github_action_helper_1.Utils.getPrefixRegExp(target), constant_1.REPLACE_NCU_COMMAND), command);
...
exports.getRunnerArguments = () => ({
    ...
    executeCommands: exports.replaceNcuCommands(getArrayInput('EXECUTE_COMMANDS', false, '&&', false)),
