...
const { getRepository } = github_action_helper_1.ContextHelper;
const helper = new github_action_helper_1.GitHelper(new github_action_helper_1.Logger(misc_1.replaceDirectory), {
    depth: -1,
    filter: (line) => misc_1.filterGitStatus(line) && misc_1.filterExtension(line),
});
...
exports.getRefDiff = (compare, logger) => __awaiter(void 0, void 0, void 0, function* () {
    logger.startProcess('Checking references diff...');
    yield helper.fetchBranch(getWorkspace(), compare, github_1.context);
    return (yield helper.getRefDiff(getWorkspace(), 'HEAD', compare, misc_1.getGitFilterStatus(), '..')).filter(misc_1.filterExtension);
});
...
exports.config = (logger) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.abortMerge = (logger) => __awaiter(void 0, void 0, void 0, function* () {
    logger.startProcess('Aborting merge...');
    yield helper.runCommand(getWorkspace(), 'git merge --abort');
});
exports.commit = (logger) => __awaiter(void 0, void 0, void 0, function* () {
    yield exports.config(logger);
    logger.startProcess('Committing...');
    yield helper.makeCommit(getWorkspace(), misc_1.getCommitMessage());
});
exports.push = (branchName, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
...
const forcePush = (branchName, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    logger.startProcess('Pushing to %s@%s...', getRepository(context), branchName);
    yield helper.forcePush(getWorkspace(), branchName, context);
});
...
exports.getChangedFiles = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield exports.checkBranch(logger, context)) {
        if (yield exports.merge(misc_1.getPrHeadRef(context), logger)) {
            if ((yield exports.getRefDiff(misc_1.getPrHeadRef(context), logger)).length) {
                yield exports.push(misc_1.getPrBranchName(context), logger, context);
            }
        }
        else {
            yield exports.abortMerge(logger);
        }
    }
...
exports.resolveConflicts = (branchName, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield exports.merge(misc_1.getPrHeadRef(context), logger)) {
        // succeeded to merge
        yield exports.push(branchName, logger, context);
    }
    else {
        // failed to merge
        ...
        yield exports.commit(logger);
        yield forcePush(branchName, logger, context);
