...
exports.clone = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield helper.cloneBranch(getWorkspace(), misc_1.getBranch(context), context);
});
const getClearPackageCommands = () => __awaiter(void 0, void 0, void 0, function* () {
...
const getInstallPackagesCommands = (workDir) => __awaiter(void 0, void 0, void 0, function* () {
...
const getExecuteCommands = () => __awaiter(void 0, void 0, void 0, function* () { return getArrayInput('EXECUTE_COMMANDS'); });
exports.getCommitCommands = () => __awaiter(void 0, void 0, void 0, function* () { return (['git add --all']); });
...
exports.getChangedFiles = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const commands = new Array().concat.apply([], [
        yield getClearPackageCommands(),
        yield getInstallPackagesCommands(getWorkspace()),
        yield getExecuteCommands(),
        yield exports.getCommitCommands(),
    ]);
    return {
        files: yield exports.getDiff(logger),
        output: yield helper.runCommand(getWorkspace(), commands),
    };
});
