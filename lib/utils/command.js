...
exports.getRefDiff = (base, compare, logger) => __awaiter(void 0, void 0, void 0, function* () {
    logger.startProcess('Checking references diff...');
    yield helper.runCommand(getWorkspace(), ['git branch']);
    yield helper.runCommand(getWorkspace(), ['git branch -a']);
