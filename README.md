...
- The following activity types must be explicitly specified ([detail](https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#pull_request))
